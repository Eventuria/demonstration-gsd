...
streamWorkspaceId :: Streamable stream monad WorkspaceId => AggregateIdStream persistedStream -> Streaming persistedStream -> stream monad (SafeResponse (Persisted WorkspaceId))
streamWorkspaceId aggregateIdStream Streaming {streamAll} = streamAll aggregateIdStream


streamCommand ::  Streamable stream monad Command => GetCommandStream persistedStream -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted GsdCommand))
...
streamInfinitelyCommand ::  Streamable stream monad Command => GetCommandStream persistedStream -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted GsdCommand))
...
streamCommandResponse ::  Streamable stream monad CommandResponse => GetCommandResponseStream persistedStream -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted CommandResponse))
...
streamEvent ::  Streamable stream monad Event => GetEventStream persistedStream -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted GsdEvent))
...
streamInfinitelyEvent ::  Streamable stream monad Event => GetEventStream persistedStream -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted GsdEvent))
...
streamValidationState ::  Streamable stream monad (ValidationState GsdState) => GetValidateStateStream persistedStream GsdState -> Streaming persistedStream -> WorkspaceId -> stream monad (SafeResponse (Persisted (ValidationState GsdState)))
