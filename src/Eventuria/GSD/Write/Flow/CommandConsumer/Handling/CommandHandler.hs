...
module Eventuria.GSD.Write.Flow.CommandConsumer.Handling.CommandHandler (commandHandler) where


import Eventuria.GSD.Write.Model.Commands.Command
import Eventuria.GSD.Write.Flow.CommandConsumer.Handling.CommandPredicates
...
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.CreateWorkspace as CreateWorkspace
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.RenameWorkspace as RenameWorkspace
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.SetGoal as SetGoal
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.RefineGoalDescription as RefineGoalDescription
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.StartWorkingOnGoal as StartWorkingOnGoal
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.PauseWorkingOnGoal as PauseWorkingOnGoal
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.NotifyGoalAccomplishment as NotifyGoalAccomplishment
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.GiveUpOnGoal as GiveUpOnGoal
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.ActionizeOnGoal as ActionizeOnGoal
import qualified Eventuria.GSD.Write.Flow.CommandConsumer.Handling.NotifyActionCompleted as NotifyActionCompleted
